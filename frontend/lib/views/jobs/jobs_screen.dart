  ...
  Widget _buildBody() {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              _searchCtrl.text.isEmpty ? 'No jobs available' : 'No results found',
    ...
    return RefreshIndicator(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, i) => _JobCard(job: _filtered[i] as Map<String, dynamic>),
      ),
    );
  }
}
...
class _JobCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final reqs = (job['requirements'] as List<dynamic>? ?? [])
        .take(3).map((r) => r.toString()).toList();
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.work_outline, color: primary, size: 22),
                ),
            ...
            if (reqs.isNotEmpty) ...[
              ...
              Wrap(
                ...
                children: reqs.map((r) => Container(
                  ...
                  child: Text(r, style: const TextStyle(fontSize: 11, color: primary)),
                )).toList(),
              ),
            ],
            ...
            Row(
              ...
              children: [
                _ApplyButton(jobId: job['id'] as int),
              ],
            ),
          ],
        ),
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Application submitted! AI is analyzing your CV... ⚙️'),
      ...
      return Container(
        ...
        child: const Row(
          ...
          children: [
            ...
            SizedBox(width: 4),
            Text('Applied', style: TextStyle(color: Colors.green, fontWeight: FontWeight.w600, fontSize: 13)),
          ],
        ),
      );
    }
